...
%This function was generated by loadlibrary.m parser version 1.1.6.38 on Thu Jul  2 11:51:32 2020
...
fcns.name{fcnNum}='SetMotorTorqueIM483Ix'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'IM483IPtr', 'int32'};fcnNum=fcnNum+1;
...
structs.s_RTL_CRITICAL_SECTION.members=struct('DebugInfo', 's_RTL_CRITICAL_SECTION_DEBUGPtr', 'LockCount', 'long', 'RecursionCount', 'long', 'OwningThread', 'voidPtr', 'LockSemaphore', 'voidPtr', 'SpinCount', 'ulong');
...
structs.s_SbgEComProtocol.members=struct('pLinkedInterface', 's_SbgInterfacePtr', 'rxBuffer', 'uint8#4096', 'rxBufferSize', 'uint32');
