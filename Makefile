...
CFLAGS += -I. -I.. -DDISABLE_THREADS_OSNET
...
hardwarex.o: hardwarex.cpp hardwarex.h OSCore.h OSTime.h OSMisc.h OSNet.h OSComputerRS232Port.h RS232Port.h MT.h RazorAHRS.h NMEADevice.h SwarmonDevice.h P33x.h SSC32.h Maestro.h MiniSSC.h MDM.h Hokuyo.h 
	$(CC) $(CFLAGS) -c $<

$(LIB): hardwarex.o OSNet.o OSComputerRS232Port.o OSMisc.o OSTime.o OSCore.o
