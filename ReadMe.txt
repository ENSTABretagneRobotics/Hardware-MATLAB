...
Linux/macOS: 
- If it does not work like for Windows, try rebuilding the library by following the instructions in the `Makefile`, note that a `CMakeLists.txt` is also provided for cmake.
...
Tested on Windows 10 64 bit using MATLAB R2022b 64 bit and MATLAB R2015b 32 bit, Ubuntu 18.04 64 bit using MATLAB R2017b 64 bit.
