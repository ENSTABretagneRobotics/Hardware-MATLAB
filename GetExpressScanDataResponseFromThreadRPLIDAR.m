function [result, distances, angles, bNewScan] = GetExpressScanDataResponseFromThreadRPLIDAR(pRPLIDAR)
...
result = calllib('hardwarex', 'GetExpressScanDataResponseFromThreadRPLIDARx', pRPLIDAR, pDistances, pAngles, pbNewScan);
