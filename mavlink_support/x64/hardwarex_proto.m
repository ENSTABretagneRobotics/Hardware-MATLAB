...
%This function was generated by loadlibrary.m parser version  on Sat May  7 00:08:58 2016
...
structs.NMEADATA.members=struct('utc', 'double', 'date', 'double', 'pressure', 'double', 'temperature', 'double', 'cpressure', 'int8', 'ctemperature', 'int8', 'winddir', 'double', 'windspeed', 'double', 'cwinddir', 'int8', 'cwindspeed', 'int8', 'awinddir', 'double', 'awindspeed', 'double', 'cawinddir', 'int8', 'cawindspeed', 'int8', 'latdeg', 'int32', 'longdeg', 'int32', 'latmin', 'double', 'longmin', 'double', 'szlatdeg', 'int8#3', 'szlongdeg', 'int8#4', 'north', 'int8', 'east', 'int8', 'GPS_quality_indicator', 'int32', 'nbsat', 'int32', 'hdop', 'double', 'height_geoid', 'double', 'status', 'int8', 'sog', 'double', 'cog', 'double', 'mag_cog', 'double', 'heading', 'double', 'deviation', 'double', 'variation', 'double', 'dev_east', 'int8', 'var_east', 'int8', 'nbsentences', 'int32', 'sentence_number', 'int32', 'seqmsgid', 'int32', 'AIS_channel', 'int8', 'nbfillbits', 'int32', 'Latitude', 'double', 'Longitude', 'double', 'Altitude', 'double', 'SOG', 'double', 'COG', 'double', 'year', 'int32', 'month', 'int32', 'day', 'int32', 'hour', 'int32', 'minute', 'int32', 'second', 'double', 'Heading', 'double', 'WindDir', 'double', 'WindSpeed', 'double', 'ApparentWindDir', 'double', 'ApparentWindSpeed', 'double', 'AIS_Latitude', 'double', 'AIS_Longitude', 'double', 'AIS_SOG', 'double', 'AIS_COG', 'double');
...
structs.MAESTRO.members=struct('RS232Port', 'RS232PORT', 'pfSaveFile', 's_iobufPtr', 'LastPWs', 'int32#5', 'szCfgFilePath', 'int8#256', 'szDevPath', 'int8#256', 'BaudRate', 'int32', 'timeout', 'int32', 'bSaveRawData', 'int32', 'DeviceNumber', 'int32', 'MinPWs', 'int32#5', 'MidPWs', 'int32#5', 'MaxPWs', 'int32#5', 'InitPWs', 'int32#5', 'ThresholdPWs', 'int32#5', 'CoefPWs', 'double#5', 'bProportionalPWs', 'int32#5', 'rudderchan', 'int32', 'rightthrusterchan', 'int32', 'leftthrusterchan', 'int32', 'rightfluxchan', 'int32', 'leftfluxchan', 'int32', 'analoginputchan', 'int32', 'MinAngle', 'double', 'MidAngle', 'double', 'MaxAngle', 'double', 'analoginputvalueoffset', 'double', 'analoginputvaluecoef', 'double', 'bEnableSetMultipleTargets', 'int32');
...
structs.MAVLINKDATA.members=struct('heartbeat', 's_mavlink_heartbeat_t', 'gps_raw_int', 's_mavlink_gps_raw_int_t', 'attitude', 's_mavlink_attitude_t', 'scaled_pressure', 's_mavlink_scaled_pressure_t', 'optical_flow', 's_mavlink_optical_flow_t', 'optical_flow_rad', 's_mavlink_optical_flow_rad_t', 'rc_channels_raw', 's_mavlink_rc_channels_raw_t', 'servo_output_raw', 's_mavlink_servo_output_raw_t', 'vfr_hud', 's_mavlink_vfr_hud_t', 'statustext', 's_mavlink_statustext_t');
structs.MAVLINKDEVICE.members=struct('RS232Port', 'RS232PORT', 'pfSaveFile', 's_iobufPtr', 'LastMAVLinkData', 'MAVLINKDATA', 'LastPWs', 'int32#8', 'szCfgFilePath', 'int8#256', 'szDevPath', 'int8#256', 'BaudRate', 'int32', 'timeout', 'int32', 'bSaveRawData', 'int32', 'quality_threshold', 'int32', 'flow_comp_m_threshold', 'double', 'bDefaultVrToZero', 'int32', 'MinPWs', 'int32#8', 'MidPWs', 'int32#8', 'MaxPWs', 'int32#8', 'InitPWs', 'int32#8', 'ThresholdPWs', 'int32#8', 'CoefPWs', 'double#8', 'bProportionalPWs', 'int32#8');
methodinfo=fcns;